...
func main() {
	...
	$ stargo cluster                  # Manage multiple StarRocks Cluster
	Usage:
  		stargo cluster [command]
	Cluster Component Available Commands:
  		deploy         Deploy a cluster for production
  		start          Start a StarRocks cluster
  		stop           Stop a StarRocks cluster
  		scale-in       Scale in a StarRocks cluster
	  	scale-out      Scale out a StarRocks cluster
	  	destroy        Destroy a specified cluster
	  	upgrade        Upgrade a specified StarRocks cluster
